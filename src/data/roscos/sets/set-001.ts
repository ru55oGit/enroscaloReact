...
const ROSCO_2: RoscoEntry[] = [
  ...
  { word: "Darwin", startOrContain: "start", letter: "D", definition: "Apellido del naturalista inglés que formuló la teoría de la evolución de las especies.", category: "personalidades" },
  ...
  { word: "Newton", startOrContain: "start", letter: "N", definition: "Apellido del científico inglés que describió la ley de gravitación universal.", category: "personalidades" },
...
const ROSCO_3: RoscoEntry[] = [
  ...
  { word: "Borges", startOrContain: "start", letter: "B", definition: "Apellido del célebre escritor argentino autor de cuentos como El Aleph.", category: "personalidades" },
  ...
  { word: "Favaloro", startOrContain: "start", letter: "F", definition: "Apellido del médico argentino que desarrolló la técnica del bypass coronario.", category: "personalidades" },
  ...
  { word: "Picasso", startOrContain: "start", letter: "P", definition: "Apellido del pintor español creador del cubismo junto a Braque.", category: "personalidades" },
...
const ROSCO_5: RoscoEntry[] = [
  ...
  { word: "Ginobili", startOrContain: "start", letter: "G", definition: "Apellido del basquetbolista argentino campeón olímpico y figura de la NBA.", category: "personalidades" },
...
const ROSCO_7: RoscoEntry[] = [
  ...
  { word: "Cortazar", startOrContain: "start", letter: "C", definition: "Apellido del escritor argentino autor de la novela Rayuela.", category: "personalidades" },
