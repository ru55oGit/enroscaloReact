...
const ROSCO_3: RoscoEntry[] = [
  ...
  { word: "Freud", startOrContain: "start", letter: "F", definition: "Apellido del neurólogo austriaco fundador del psicoanálisis y creador del concepto de inconsciente.", category: "personalidades" },
